  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col px-5 pt-10 pb-10 w-full max-w-sm mx-auto">
        {/* Wordmark */}
        <div className="mb-5">
          <h1 className="font-extrabold leading-none" style={{ fontSize: 38, color: '#FFF9EF' }}>
            Belong<span style={{ color: '#B52900' }}>.</span>
          </h1>
          <p className="text-muted text-xs mt-1.5 tracking-wide">powered by music, held by people</p>
        </div>
        ...
        {/* Title block */}
        <h2 className="font-extrabold text-xl leading-snug mb-1.5" style={{ color: '#FFF9EF' }}>
        ...
        {/* Divider */}
        <div className="w-8 h-px mb-4" style={{ background: 'rgba(255,249,239,0.12)' }} />
        ...
        {/* Edition hint — line break between Ed1 and Ed2 */}
        <p className="text-xs mb-1" style={{ color: '#5C524E' }}>
          Edition 1 · Bollywood, Hindi &amp; Desi
        </p>
        <p className="text-xs mb-5" style={{ color: '#5C524E' }}>
        ...
        <button
          ...
          className="w-full py-3.5 rounded-2xl font-bold text-cream text-sm mb-2.5"
        ...
        <button
          ...
          className="w-full py-3 rounded-2xl text-xs font-medium text-muted"
